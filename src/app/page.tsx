...
const projects = [
  {
    ...
    impact: '450+ NPM downloads • Open source with active development • Production-ready package • TypeScript support',
  ...
  },
  {
    ...
    challenge: 'Architected a scalable data annotation platform with microservices handling real-time notifications across multiple catalog applications.',
    impact: 'Processed 10,000+ data annotations • Reduced development time by 40% • Improved team productivity • Won Rakuten Excellence Award',
  ...
  },
  {
    ...
    description: 'Online bidding platform for oil and gas industry with real-time bidding, user management, and deal negotiation capabilities.',
    challenge: 'Built a high-performance real-time bidding system handling concurrent auctions with sub-second response times.',
    impact: 'Processed $2M+ in bids • Served 5,000+ industry professionals • 95% user satisfaction rate',
    role: 'Fullstack Developer',
    tech: ['React', 'Go', 'Ant Design', 'PostgreSQL', 'WebSockets'],
    image: 'https://via.placeholder.com/400x300'
  },
  {
    title: 'Opendev Property Platform',
    description: 'Property marketplace enabling users to buy, sell, and negotiate real estate online with integrated payment processing.',
    challenge: 'Developed a secure property marketplace with complex search algorithms, payment integration, and real-time messaging.',
    impact: 'Listed 10,000+ properties • Facilitated $5M+ in transactions • 8,000+ registered users',
    role: 'Fullstack Developer',
    tech: ['React', 'Go', 'Ant Design', 'PostgreSQL', 'Payment APIs'],
    image: 'https://via.placeholder.com/400x300'
  },
  {
    title: 'EzzHealth Medical Portal',
    description: 'Healthcare platform connecting patients with doctors, hospitals, and clinics through an intelligent appointment booking system.',
    challenge: 'Built advanced search algorithms with Elasticsearch to match patients with appropriate healthcare providers based on location, specialty, and availability.',
    impact: 'Served 25,000+ patients • Booked 100,000+ appointments • Improved customer satisfaction by 40% • Reduced helpdesk tickets by 25%',
    role: 'Fullstack Developer',
